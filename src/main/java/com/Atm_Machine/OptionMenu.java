...
public class OptionMenu {
	...
	public void getLogin() throws IOException {
		...
		while (!end) {
			try {
				...
				customerNumber = menuInput.nextLong();
	...
	public void mainMenu() throws IOException {
		data.put(Long.valueOf(1234567891), new Account(1234567891, 7890));
		data.put(Long.valueOf(1234567890), new Account(1234567890, 7090));
